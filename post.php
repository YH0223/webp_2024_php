...
<div class="content-container">
        ...
        <?php 
            ...
            if ($writer != $_SESSION['userid']) {
                $update_hit_sql = "UPDATE board SET hit = hit + 1 WHERE idx = $idx";
        ...
        <div class="board-details">
            ...
            <div class="detail-item">
                ...
                <?php 
                    if($row['img_url']){
                        echo "<img src='{$row["img_url"]}' alt='첨부 이미지' class='post-image' style='max-width: 300px; height=auto;'><br>";
                    }
                ?>
            </div>
        </div>
        ...
        <div class="button-group">
            ...
            <?php if($writer==$_SESSION['userid']||$_SESSION['userid']==='admin'){
                echo '<a href="update.php?idx='.$idx.'" class="btn btn-primary">수정</a>';
                echo '<a href="delete.php?idx='.$idx.'" class="btn btn-danger">삭제</a>';
            }
            ?>
