...
<body>
    ...
    if (is_uploaded_file($tmp_file)) {
        ...
        // 현재 게시글의 인덱스(id) 가져오기
        $result = mysqli_query($db, "SELECT COUNT(img_url) AS cntimg FROM board WHERE userid='$userid'");
    ...
    $sql="insert into board values(null,'$userid','$title','$content',0,now(),'$ip','$img_url');";
