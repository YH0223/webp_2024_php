...
<div class="form-container">
    <div class="mainlist" onclick="window.location.href='list.php';">
        ...
        include "db.php";
        $prow=5;
        $sql="select count(*) as total from boardadmin";
        ...
        $sql="select * from boardadmin order by idx desc limit $start,$prow";
        $res=mysqli_query($db,$sql);
            ...
            for($i=0;$i<$num;$i++){
                ...
                <div class="board-item">
                    <div class="board-item-header">
                        <?php if ($row['notice']==1): ?>
                        <img src="./src/star_icon.png" alt="이미지" class="board-item-image" >
                        <?php endif; ?>
                        <span class="board-item-number">번호 <?= $row['idx'] ?></span>
                        <span class="board-item-author">작성자 : <?= $row['userid'] ?></span>
                    </div>
                    <a href="adminpost.php?idx=<?= $row['idx'] ?>" class="board-item-title">
        ...
        <div class="action-links">
            <?php if($_SESSION['userid']=='admin'){ ?>
                <a href="adminwrite.php" class="btn btn-primary">글쓰기</a>
                <?php } ?>
